<%@ Control Language="C#" AutoEventWireup="true" CodeBehind="LoginControl.ascx.cs" Inherits="OnTaskBare.LoginControl" %>
...
<asp:Button ID="cmdLogIn" runat="server" text="Login" onclick="cmdLogIn_Click"  style="height: 26px" />
<br /><br />
